...
<div class="risk-badge" class:low={portfolio.riskLevel === 'Bajo'} class:moderate={portfolio.riskLevel === 'Moderado'} class:high={portfolio.riskLevel === 'Alto'}>
{portfolio.riskLevel}
</div>
</div>
...
<p class="value">${new Intl.NumberFormat('es-CO').format(portfolio.totalValue)}</p>
</div>
