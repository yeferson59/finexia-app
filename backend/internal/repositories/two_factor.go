...
func (r *Repository) GetTwoFactor(ctx context.Context, userID uuid.UUID) (entities.TwoFactor, error) {
	var tf entities.TwoFactor
	...
	if errors.Is(err, pgx.ErrNoRows) {
		return entities.TwoFactor{}, ErrTwoFactorNotFound
	}
	if err != nil {
		return entities.TwoFactor{}, err
	}
	return tf, nil
}
...
func (r *Repository) UpsertTwoFactorSecret(ctx context.Context, userID uuid.UUID, secret string) error {
...
func (r *Repository) DeleteTwoFactor(ctx context.Context, userID uuid.UUID) error {
...
func (r *Repository) ReplaceTwoFactorRecoveryCodes(ctx context.Context, userID uuid.UUID, codeHashes []string) error {
	tx, err := r.db.Begin(ctx)
	if err != nil {
		return err
	}
...
func (r *Repository) ConsumeTwoFactorRecoveryCode(ctx context.Context, userID uuid.UUID, codeHash string) error {
	tag, err := r.db.Exec(ctx,
...
func (r *Repository) CountUnusedTwoFactorRecoveryCodes(ctx context.Context, userID uuid.UUID) (int, error) {
	var count int
	err := r.db.QueryRow(ctx,
