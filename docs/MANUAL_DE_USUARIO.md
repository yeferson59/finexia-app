...
> **Si el dinero salió de tu saldo, dilo.** Con la casilla **Pagarlo con mi efectivo en esta plataforma** marcada, el total invertido se resta del efectivo de esa cuenta (sección 9.5), que es lo que hace el bróker. Si esa cuenta tiene bolsillos, **De dónde sale** te deja elegir de cuál —la cuenta principal o cualquier bolsillo, con su saldo al lado—; los depósitos a plazo no salen en la lista, porque están cerrados hasta que vencen (sección 9.8). Debajo ves cuánto hay en el elegido; si no alcanza, Finexia te avisa y no da de alta la posición. Tu rentabilidad no cambia por marcarla —ese dinero ya estaba en tu portafolio—, pero el saldo sigue cuadrando con tu extracto. Déjala sin marcar si transferiste el dinero para esta compra.
...
> **Y las compras se descuentan solas.** Una compra registrada con la casilla **Pagarlo con mi efectivo en esta plataforma** marcada (ver 7.1 y 10.2) aparece aquí como **Compra de AAPL**, restando lo que pagaste —comisión incluida— del saldo o del bolsillo que la pagó. Tampoco se edita ni se borra desde esta lista: **Ver compra** te lleva a la operación, y es ahí donde se cambia o se deshace. Tu rentabilidad no cambia por eso —el dinero ya estaba en tu portafolio y solo cambió de forma—, pero el saldo vuelve a cuadrar con tu extracto sin que tengas que anotar un retiro.
...
5. Si es una **compra** y esa plataforma tiene efectivo en la moneda de tu cuenta, aparece la casilla **Pagarlo con mi efectivo en esta plataforma**, con lo que hay disponible debajo. Márcala si el dinero salió de ese saldo: se resta lo que pagaste, comisión incluida, y el saldo queda como en tu extracto. Con varios saldos en esa cuenta, **De dónde sale** elige el cajón —la cuenta principal o un bolsillo—; los depósitos a plazo no están, porque siguen cerrados. Déjala sin marcar si transferiste el dinero para esta compra. Si lo que hay no alcanza, Finexia te avisa y no registra la compra hasta que el saldo lo cubra.
...
Una compra pagada con el efectivo lleva debajo **Pagado con el efectivo**, y la ventana de edición trae su casilla marcada y el cajón del que sale ya elegido. Es también donde se registra después del hecho: **marca la casilla en una compra vieja y el dinero sale del saldo ahora**, aunque la anotaras hace meses sin que Finexia llevara tu efectivo. Al revés, desmarcarla devuelve el dinero al saldo, y eliminar la compra también. Si cambias el cajón, el dinero vuelve al anterior y sale del nuevo; ninguna otra edición lo mueve de sitio.
